...
/**
 * sys_i18n_language表相关领域对象转化类
 *
 * @author pan
 * @since 2020-09-27
 */
@Mapper(componentModel = "spring", uses = {StringDataMapper.class})
public interface I18nLanguageMapStruct extends ComplexMapStruct<I18nLanguageSearchDTO, I18nLanguageAddDTO, I18nLanguageEditDTO, I18nLanguage, I18nLanguageVO> {
